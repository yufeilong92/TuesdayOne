...
/*    @Override
    ...
    private void submiteDoBank() {
        ...
        if (vo == null || vo.getError() == 0) {
            RequestErrorService.startActionFoo(mContext,userInfomVo.getSaffid());
        }

        if (vo == null || vo.getCollect() == 0) {
            RequestCollectService.startActionFoo(mContext,userInfomVo.getSaffid());
        }
